...
const Chat = ({ isDarkmode, socket, username, userPic, userId }) => {
    ...
    return (
        <div className="relative overflow-y-auto flex flex-col flex-1 border-t-1 bg-white border-grayLight2">
