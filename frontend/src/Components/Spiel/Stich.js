    ...
    return (
        <div className="bg-white dark:bg-whiteDark relative flex justify-center items-center w-full h-96 xl:h-64 rounded-b-st">
            <div className="h-56 w-56 relative">
                <img
                    className={`h-auto w-2.875rem absolute top-0 left-1/2 border-2 ${
                ...
                />
                <img
                    className={`h-auto w-2.875rem absolute top-1/2 left-0 border-2 ${
                ...
                />
                <img
                    className={`h-auto w-2.875rem absolute top-1/2 right-0 border-2 ${
                ...
                />
                <img
                    className={`h-auto w-2.875rem absolute bottom-0 left-1/2 border-2 ${
